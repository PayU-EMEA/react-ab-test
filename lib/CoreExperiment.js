...
var CoreExperiment = function (_Component) {
  ...
  function CoreExperiment(props) {
    ...
    var value = typeof props.value === "function" ? props.value() : props.value;
    if (!_this.state.variants[value]) {
      if ("production" !== process.env.NODE_ENV) {
        (0, _warning2.default)(true, 'Experiment “' + props.name + '” does not contain variant “' + value + '”');
      }
    }
    _emitter2.default._incrementActiveExperiments(props.name);
    _emitter2.default.setActiveVariant(props.name, value);
    _emitter2.default._emitPlay(props.name, value);
