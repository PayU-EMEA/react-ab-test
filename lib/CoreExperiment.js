...
var CoreExperiment = function (_Component) {
  ...
  function CoreExperiment(props) {
    ...
    _this.state.rawChildren = props.children;
    ...
    var value = typeof _this.props.value === "function" ? _this.props.value() : _this.props.value;
    if (!_this.state.variants[value]) {
      if ("production" !== process.env.NODE_ENV) {
        (0, _warning2.default)(true, 'Experiment “' + _this.props.name + '” does not contain variant “' + value + '”');
      }
    }
    _emitter2.default._incrementActiveExperiments(_this.props.name);
    _emitter2.default.setActiveVariant(_this.props.name, value);
    _emitter2.default._emitPlay(_this.props.name, value);
